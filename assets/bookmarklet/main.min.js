! function()
{
  function e()
  {
    n(r + "assets/bookmarklet_modal.css"), jQuery.getJSON(r + "yieldtracks/script.json?callback=?", function(e)
    {
      null == e ? t(r + "assets/bookmarklet/error_msg.js", function() {}) : (window._YT.vars = {
        state: e.state,
        site: e.site,
        search_term: e.search_term,
        engine: e.engine,
        tpp: e.tpp
      }, t(r + "scripts/" + e.script_id, function() {}))
      console.log("e: " + e)
    })
  }
  ...
  window._YT = {};
  var r = document.querySelector("[data-cf-bm]").getAttribute("data-base-url");
  ! function()
  {
    if ("undefined" != typeof jQuery) e();
    else
    {
      var n = r + "assets/bookmarklet/jquery.min.js";
      t(n, e)
    }
  }.call(this), ! function()
  {
  ...
  }.call(this), ! function()
  {
    window._YT.Timer = {
      init: function(e, t)
      {
        return 0 == e || void 0 == e ? void this.fire() : (this.pageLeaveListener(), count = e, this.start(e, t), this.createVisual(e), this.appendVisual(), void(masterFunc = this))
      },
      ...
      start: function(e, t)
      {
        function n()
        {
          ...
          return count -= 1, 0 >= count ? (masterFunc.updateVisual(count), clearInterval(r), masterFunc.fire(), void(void 0 == t ? masterFunc.completeVisual() : (masterFunc.removeVisual(), t()))) : void masterFunc.updateVisual(count)
        }
      ...
      fire: function()
      {
        var e = [],
          t = (new Date).valueOf();
        e.push("referrer=" + encodeURIComponent(document.referrer)), e.push("x=" + t), e.push("tpp=" + _YT.vars.tpp), jQuery("body").append('<img src="' + r + "yieldtracks/verify?" + e.join("&") + '" alt="" width="1" height="1" style="display:block;  position:relative; left:-10000px;"/>')
      }
    }
  }.call(this), ! function()
  {
