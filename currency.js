! function()
{
  ...
  // debugger;
    ...
    function S(e, t, a, i, r, n, secondaryTicker, secondaryPrice, tertiaryTicker, tertiaryPrice, l, s, d, p, m, u, h, g, v, f)
    {
      ...
      valVolume = d ? k(d, 2) : "?",
      secondaryTicker
      ? (mainLineHeight = 25, valPriceSecondary = secondaryPrice ? P(secondaryPrice, secondaryTicker) : "?", secondaryHTML = '<br><span style="font-size: 12px; color: rgba(39, 52, 64, 0.5)">' + valPriceSecondary + " " + secondaryTicker + " </span>")
      : (mainLineHeight = 30, secondaryHTML = ""),
      tertiaryTicker
      ? (mainLineHeight = 25, valPriceSecondary = tertiaryPrice ? P(tertiaryPrice, tertiaryTicker) : "?", tertiaryHTML = '<br><span style="font-size: 12px; color: rgba(39, 52, 64, 0.5)">' + valPriceSecondary + " " + tertiaryTicker + " </span>")
      : (mainLineHeight = 30, tertiaryHTML = "");
      var y = "utm_medium=widget&utm_campaign=cmcwidget&utm_source=" + location.hostname + "&utm_content=" + e,
        w = '<div style="border:2px solid #e1e5ea;border-radius: 10px;font-family: \'Helvetica Neue\',Helvetica,Arial,sans-serif;min-width:285px;">    <div>        <div style="float:right;width:67%;border: none;text-align:left;padding:5px 0px;line-height:' + mainLineHeight + 'px;">            <span style="font-size: 18px;"><a href="https://coinmarketcap.com/currencies/' + e + "/?" + y + '" target="_blank">' + t + " " + valTickerHTML + '</a></span> <br>            <span style="font-size: 16px;">' + valPrice + " " + i + " " + valPercentHTML + "</span></span>            " + secondaryHTML + tertiaryHTML + '        </div>        <div style="text-align:center;padding:5px 0px;width:33%;"><img src="' + x + '"></div>    </div>';
      ...
      }(u, h, g, v, r, p, valMarketCap, valVolume), w += '    <div style="border-top: 1px solid #e1e5ea;text-align:center;clear:both;font-size:10px;font-style:italic;padding:5px 0;">        <a href="https://coinmarketcap.com?' + y + '" target="_blank">Powered by CoinMarketCap</a>    </div></div>'
    }
      ...
      console.log("M.get = " + M.get)
        ...
        e = f ? "https://widgets.coinmarketcap.com/v2/ticker/" + f + "/?ref=widget&convert=" + x : "https://widgets.coinmarketcap.com/v1/ticker/" + v + "/?ref=widget&convert=" + x, M.get(
        {
          ...
          success: function(e)
          {
            ...
            {
            console.log("success if branch: e == " + e)
            var quote1 = e.quotes[x.toUpperCase()]
            var quote2 = e.quotes[b.toUpperCase()]
            console.log(quote1)
            console.log(quote2)
            var t = e.quotes[x.toUpperCase()],
              a = {"price":1337} //b ? e.quotes[b.toUpperCase()] : null,
              i = parseFloat(t.price),
              r = a ? parseFloat(a.price) : null,
              n = parseInt(e.quotes[y].market_cap),
              o = parseInt(e.quotes[y].volume_24h),
              c = Number(t.percent_change_24h);
            }
            else
            {
            console.log("success else branch: e == " + e)
